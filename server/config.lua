-- Crystal Server Configuration Fazendo Tibia
...
serverMotd = "Welcome to the FazendoTibia Server!"
...
forgeBaseSuccessRate = 95
forgeBonusSuccessRate = 5
forgeTierLossReduction = 100
forgeAmountMultiplier = 25
forgeMinSlivers = 8
forgeMaxSlivers = 20
forgeInfluencedLimit = 1000
forgeFiendishLimit = 25
...
â€¢ When set to true, the transfers will only occur during a server restart.
...
â€¢ This could potentially freeze the server due to the heavy operation. It's advised to keep this setting enabled (true) to minimize risks.
]]
...
combatChainSkillFormulaClub = 1.2
...
rateBossHealth = 0.6
rateBossAttack = 0.45
rateBossDefense = 0.75

bossDefaultTimeToFightAgain = 0 -- no cooldown
...
ownerName = "FazendoTibia"
ownerEmail = "@gmail.com"
url = "https://www.youtube.com/@fazendotibia/videos"
...
vipStayOnline = false
vipFamiliarTimeCooldownReduction = 50
vipKeepHouse = false
